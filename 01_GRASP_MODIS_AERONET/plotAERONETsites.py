...
# SITES MUST HAVE AT LEAST ONE COLOCATION, USE [len(si)==0 for si in siteInd]
...
npzPath = os.path.join(basePath, 'Remote_Sensing_Projects/GRASP_MODIS/Ocean_MOD04_L2_C61_V2c.out.npz')

DB = modaeroDB(npzPath, 'ocean')
#DB.groupData(siteID)
...
#m = Basemap(projection='merc', resolution='c', llcrnrlon=-173.1, llcrnrlat=-57.6, urcrnrlon=190.5, urcrnrlat=83.7)
...
plt.plot(x, y, c='r', markersize=10, marker='.', mfc='r', linestyle='none')
