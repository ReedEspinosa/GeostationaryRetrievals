...
siteID = [97, 919] # can be int or list (not numpy array)
...
savePath = os.path.join(basePath, 'Working/GRASP_testCases/testNew.pkl') # Save results here
...
rslts = gDB.processData(maxCPUs, binPathGRASP, savePath)
