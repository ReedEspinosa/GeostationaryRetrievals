...
siteID = np.r_[9, 161, 649, 1126, 1149, 518, 510, 268, 196, 514, 59, 1, 430, 221, 1150, 1197, 946, 33, 1077, 1107, 337, 806, 1102, 176, 339, 989, 658, 532, 1156, 746, 961, 981, 748, 316, 666, 485, 940, 922, 285, 33, 126] # LAND SITES
siteID = siteID[0::4]
#siteID = np.r_[9]
siteID = np.r_[97]
...
savePath = os.path.join(basePath, 'Working/MODAERO_retrievalPickles/dicoverTesting.pkl')  # Save results here
...
maxNtPerSeg=50 # how many pixels per grasp run? (DICOVER Test use 4 -> 45 grasp runs)
