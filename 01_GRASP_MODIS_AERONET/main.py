...
savePath = os.path.join(basePath, 'Working/MODAERO_retrievalPickles/TerraLand_GLOBALland_YAML6e3cdda_3lgnrm_V2c.pkl')  # Save results here
...
maxNtPerSeg=300 # how many pixels per grasp run?
