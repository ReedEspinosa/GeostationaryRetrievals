...
#npzPath = os.path.join(basePath, 'Remote_Sensing_Projects/GRASP_MODIS/Ocean_MYD04_L2_C61_V2a.out.npz') # Use AQUA ocean Data
...
savePath = os.path.join(basePath, 'Working/MODAERO_retrievalPickles_land/Terra_WallopsOnly_YAMLnewLand_3lgnrm_AEROincld_V2b.pkl')  # Save results here
...
DB = modaeroDB(None, fileType) if saveNPZ else modaeroDB(npzPath, fileType)
