...
maxPixPerRun = 30 # The maximum number of pixels to pack together in a single run of GRASP
...
savePath = '/discover/nobackup/projects/multipix_geo/GRASP_results/V0_AERONET-sites_ABI-only/TUNING_oceanSites_maxPerSite200_Ocean_V004.pkl'
rndGuess = False
showWorkingPath = True # True prints a large amount to console
dryRun = True # Pack everything up but do not actually run GRASP
